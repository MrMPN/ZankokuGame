...
@export var text_alignment: Alignments = Alignments.CENTER
...
@export var editor_preview_name: String = "Speaker"
@export_multiline var editor_preview_text: String = "This is a textbox preview in the scene editor."
...
func get_global_setting(setting_name:StringName, default:Variant) -> Variant:
	...
	if parent and parent.has_method("get_global_setting"):
		return parent.get_global_setting(setting_name, default)
	return default
...
func _apply_editor_preview() -> void:
	var name_label := get_node_or_null("%DialogicNode_NameLabel") as Label
	var dialog_text := get_node_or_null("%DialogicNode_DialogText") as RichTextLabel
	if not name_label or not dialog_text:
		return

	dialog_text.set("start_hidden", false)
	dialog_text.set("hide_when_empty", false)
	name_label.set("hide_when_empty", false)
	name_label.text = editor_preview_name
	dialog_text.text = editor_preview_text
